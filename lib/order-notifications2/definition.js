...
function defFactory( def ){
  return utils.extend( function notificationFactory( order, options ){
...
module.exports.notificationProto = {
  build: function( callback ){
    if ( !this.isValidOrder() ){
      return this.fetchOrder( this.build.bind( this ) );
    }
...
, send: function( callback ){
    ...
    this.def.send( this.order, this.options, LOGGER, callback );

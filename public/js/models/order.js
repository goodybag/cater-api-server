...
var Order = Backbone.Model.extend({
  ...
  validate: function(attrs, options) {
    ...
    var addressErrors = this.address._validate(_.extend({}, this.address.attributes, _.pick(attrs, addressFields)),
                                              _.extend({enforceRequired: false}, options));
    if (addressErrors != null)
      errors.push({addressErrors: _.isArray(addressErrors) ? addressErrors : Array.prototype.slice.call(addressErrors)});

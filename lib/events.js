...
var restaurants = {
  'restaurant_contact:created':
  function onRestaurantContactCreate( rContact ){
    utils.sendMail2({
      to: config.restaurantContactRecipients
    , from: config.emails.info
    , subject: '[Restaurant Contact] Restaurant inquiring about Goodybag'
    , html: [
        '<p>A restaurant just requested to be a caterer. Here are the details</p>'
      ].concat(
        Object.keys( rContact ).map( function( k ){
          return [

...
var url     = arg(['url', 'u']);
var output  = system.args[['output', 'o']];
var page    = webpage.create();
var creds   = {
  email:      arg( ['email', 'e'],    config.credentials.email )
, password:   arg( ['password', 'p'], config.credentials.password )
};

var arg = function( options, fallback ){

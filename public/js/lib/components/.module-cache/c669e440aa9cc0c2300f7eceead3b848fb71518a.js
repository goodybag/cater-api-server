      ...
      return (
        React.DOM.div({className: classString}, 
          React.DOM.a({href: orderUrl}, 
            React.DOM.div(null, "#", this.props.order.id, " - ", this.props.order.restaurant.name, " @ ", datetime), 
            React.DOM.div(null, "User: ", this.props.order.user.name, " ", orgString), 
            React.DOM.div(null, "Total: $", total)
          )
        )
      );
    }

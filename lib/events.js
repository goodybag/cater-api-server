  ...
  function( order, previous ){
    ...
    , 'render-email': function( stage, done ){
        ...
        app.render( 'order-email/order-' + statusText, viewOptions, function( error, html ){
          ...
          var email = {
            to:         statusText === 'denied' ? ['jag@goodybag.com', 'sarah.southwell@goodybag.com', 'om@goodybag.com', 'jay@goodybag.com', 'jacob.parker@goodybag.com'] : order.attributes.user.email

...
, name: 'Order Submitted Needs Action SMS Reminder'
, format: 'sms'
, description: [
    'Sends an sms reminder to the restaurant informing them to accept or reject an order. '
...
, build: function( order, logger, options, callback ){
    ...
    var sms = {
      to: utils.flatten(utils.pluck(order.restaurant.contacts, 'sms_phones'))

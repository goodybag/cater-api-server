...
module.exports.register = function( user_id, callback ){
  var this_ = this;
  ...
  db.users.update( user_id, $update, options, function( error, user ){
    ...
    ordrin.create_account( ouser, function( error, result ){
      if ( error ) return callback( error );
...
module.exports.renewToken = function( user_id, callback ){
  var this_ = this;
  ...
  db.users.update( user_id, $update, options, function( error, user ){
    ...
    ordrin.change_password( ouser, function( error, result ){
      if ( error ) return callback( error );
...
, 'Object,Function':
  function( user, callback ){
    ...
    , ordrin.change_password.bind( ordrin, {
      ...
      , password:         user.ordrin_password
      , current_password: $update.ordrin_password
      })
    ], function( error, results ){
      if ( error ) return callback( error );

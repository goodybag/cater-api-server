...
module.exports.notificationProto = {
  build: function( callback ){
    ...
    this.def.build( this.order, this.options, this.logger, callback );
...
, save: function( build, callback ){
    this.def.db.order_notifications.insert({
      nid:      this.def.id
    , user_id:  this.userId
...
, fetchOrder: function( callback ){
    this.def.db.orders.findOne( this.order.id, module.exports.orderQueryOptions, function( error, order ){
      if ( error ) return callback( error );

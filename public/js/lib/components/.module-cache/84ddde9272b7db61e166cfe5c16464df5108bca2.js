      ...
      return (
        React.DOM.div({className: classString}, 
          React.DOM.a({href: orderUrl}, 
            React.DOM.div(null, "#", this.props.order.id, " - ", this.props.order.restaurant.name), 
            React.DOM.div(null, this.props.order.user.name, " ", orgString), 
            React.DOM.div(null, "Delivering ", datetime, " for $", total)
          )
        )
      );
    }

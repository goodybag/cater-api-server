...
var registerChanged = function(notification) {
  ...
  , requiredOptions: Array.isArray(notification.options) ? notification.options : null
...
var notifications = [
  { name: 'User Delivery Fee Changed', to: 'user', options: ['oldDeliveryFee']}
, { name: 'Restaurant Delivery Fee Changed', to: 'restaurant', options: ['oldDeliveryFee'] }
, { name: 'User Order Items Changed', to: 'user' }
, { name: 'Restaurant Order Items Changed', to: 'restaurant', options: ['changedDescription'], raw: true }
, { name: 'Restaurant Order Type Changed', to: 'restaurant', options: ['oldType'] }
];

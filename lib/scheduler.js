...
/**
 * This wraps up a single job and updates its final status
 *
...
// TODO: support multiple listeners per action (nice-to-have)
Scheduler.prototype.runListeners = function(job, action) {
...
Scheduler.prototype.runAll = function(callback) {
  var this_ = this;
  var tasks = this.actions.reduce(jobReduce.bind(this), {});
 ...
 * Utility fns
 */
function jobReduce(memo, action) {
  var this_ = this;

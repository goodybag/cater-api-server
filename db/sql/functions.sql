...
create or replace function get_delivery_fee( rid int, delivery_zip varchar(5) )
returns int as $$
begin
  return (
    select price from (
...
create or replace function get_delivery_fee( rid int, delivery_zip varchar(5), delivery_date date, guests int )
returns int as $$
begin
  return (
    select price from (
...
create or replace function get_delivery_fee( rid int, delivery_zip varchar(5), delivery_date date )
returns int as $$
begin
  return (
    select price from (
...
create or replace function get_delivery_fee( rid int, delivery_date date )
returns int as $$
begin
  return (
    select price from (

      ...
      return (
        React.DOM.div({className: classString}, 
          React.DOM.a({href: orderUrl}, 
            React.DOM.div(null, "Order #", this.props.order.id, " - $", total, " @ ", datetime), 
            React.DOM.div(null, this.props.order.restaurant.name, " delivering to ", this.props.order.user.name, " ", orgString)
          )
        )
      );
    }

define(function(require, exports, module) {
  ...
  return module.exports = EditRestaurantView.extend({
    ...
    , billing_bank:           '[name="billing_bank"]'
    , billing_account_number: '[name="billing_account_number"]'
    , billing_account_type:   '[name="billing_account_type"]'
    , billing_account_name:   '[name="billing_account_name"]'

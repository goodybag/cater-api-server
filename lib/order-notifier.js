...
module.exports.send = function( id, order, options, callback ){
  ...
  module.exports.getNotification( id, order, options, function( error, notification ){
    ...
    var tasks = {
      sendMail:     module.exports.getSendFn(id, notification)
...
// twilio only allows one number per api request. they also
// rate limit 1 sms/sec but queues them up.
...
module.exports.getSendFn = function(id, notification) {
  var format = module.exports.defs[id].format || 'email';
  if ( format === 'email' ) {
